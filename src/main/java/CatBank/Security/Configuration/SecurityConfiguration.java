...
import CatBank.Security.JasonWebToken.JwtEntryPoint;
import CatBank.Security.JasonWebToken.JwtTokenFilter;
import CatBank.Security.Service.CustomUserDetailsServiceImp;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception{
        auth.userDetailsService(customUserDetailsServiceImp).passwordEncoder(passwordEncoder());
    }
